...
Use this template when producing a full verification report (one-shot mode, active mode with high-stakes content, or auto-escalation from inline verification).
...
- **Finding:** [What the verification found -- what is wrong or suspicious]
- **Source:** [URL to contradicting or relevant source, if available]
- **Recommendation:** [What the user should do -- e.g., "Verify this independently before using it" or "Remove this statistic unless you can find a primary source"]
...
#### [C#] -- [Brief description]
- **Claim:** [The assertion]
- **Pattern:** [Which hallucination pattern this matches -- see hallucination-patterns.md]
- **Details:** [Why this is flagged -- e.g., "citation not found through multiple searches"]
